            ...
            Padding(
              ...
              child: IconButton(
                  onPressed: () {
                    setState(() {
                      if (dark) {
                        Provider.of<ThemeGo>(context, listen: false)
            ...
            IconButton(
                onPressed: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (builder) => TextEditor()));
                },
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                          ...
                          boxShadow: [
                            BoxShadow(
                                color:
                                    Color.lerp(Colors.grey, Colors.black, 0.5)!,
                                offset: Offset(5, 5))
                          ],
